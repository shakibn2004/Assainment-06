  ...
  return (
    ...
    <nav className="flex max-w-300 w-[75%] mx-auto justify-between items-center py-7">
      ...
      <div className="menu lg:hidden">
        ...
        <div className={`fixed top-0 right-0 max-w-90 w-[80%] h-screen bg-white pl-9 transition-all duration-400 ease-in-out ${showMenu?'translate-x-0':'translate-x-full'}`}>
          <X onClick={()=>setShowMenu(false)} className="ml-auto mr-16 mt-8" size={48} />
