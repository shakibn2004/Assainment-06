...
const Navbar = ({ selectedProduct, setRenderCard }) => {
  ...
  return (
    <header className="bg-white sticky top-0 z-10">
      <nav className="flex max-w-300 w-[95%] lg:w-[75%] mx-auto justify-between items-center py-5">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <div
                className={`${
                  !selectedProduct.length ? "hidden" : "flex"
                } items-center justify-center w-4 h-4 cursor-pointer bg-red-500 rounded-full absolute -top-1.25 left-2.5`}
              >
                <p className="text-white text-center text-sm">
                  {selectedProduct.length}
                </p>
